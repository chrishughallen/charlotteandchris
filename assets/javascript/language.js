...
const translations = {
  en: {
    ...
    seconds: "Seconds",
    dress: "Dress code",
    dress_content: "Chic and festive, but most importantly be yourself!",
    where: "Where?",
    when: "When?",
    ...
    welcome_p1: "Two countries.",
    welcome_p2: "Two cultures.",
    welcome_p3: "One very good reason to celebrate.",
    welcome_p4: "We are so excited to have you with us on our wedding day! Below you will find all the practical information you will need. If you have any further questions, please don't hesitate to reach out to us directly or send us an ",
  ...
  fr: {
    ...
    seconds: "Secondes",
    dress: "Tenue ?",
    dress_content: "Soyez chics et festifs, mais surtout soyez vous-mêmes!",
    where: "Où ?",
    when: "Quand ?",
    ...
    walk: "Le château est situé à 5 minutes à pieds. Vous etes les bienvenues dans le parc en attendant la cérémonie.",
    welcome_p1: "Deux pays.",
    welcome_p2: "Deux cultures.",
    welcome_p3: "Une très bonne raison de faire la fête.",
    welcome_p4: "Nous sommes ravis de vous compter parmi nous pour le jour de notre mariage ! Vous trouverez ci-dessous toutes les informations pratiques dont vous aurez besoin. Pour toute question supplémentaire, n'hésitez pas à nous contacter directement ou à nous envoyer un ",
    ...
    faq_a1: "Oui, les enfants sont les bienvenus. À noter qu’il n’y aura pas de service de garde d’enfants sur place.",
    ...
    faq_a5: "En raison des contraintes de capacité du lieu, nous ne pourrons malheureusement pas accueillir d’invités supplémentaires. Merci beaucoup de votre compréhension, nous avons hâte de célébrer avec vous !",
